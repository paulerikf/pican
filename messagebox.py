...
def msg():
    ...
    msgs = [
        ...
        # [0xC, 0, 0, 0, 0, 0, 0, 0]
        [0x12, 0, 0, 0xFF, randint(0, 255), randint(0, 255), randint(0, 255), randint(0, 255)],
        [0x12, 0, 0, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF]
    ]
    m = can_id[i % len(can_id)] + msgs[randint(0, 1)]
    # m = can_id[5] + msgs[4]
    i += 1
    return m
